...
Item(B(-C) I(actions),B(--chroot-actions)=I(actions))
Mimic setting the rule attribute B(chroot_actions)=I(actions).
I(actions) is a comma separated list of actions.
