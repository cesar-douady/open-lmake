...
,	'ete'                 : ( float , False )
,	'external_read_ok'    : ( bool  , True  )
,	'external_write_ok'   : ( bool  , True  )
,	'force'               : ( bool  , False )
,	'ignore_stat'         : ( bool  , True  )
,	'io_uring_ok'         : ( bool  , True  )
,	'job_name'            : ( str   , False )
,	'keep_tmp'            : ( bool  , True  )
,	'kill_daemons'        : ( bool  , True  )
...
class Handle :
	...
	def handle_start_rsrcs(self) :
		...
		self._handle_val( 'external_read_ok'                                )
		self._handle_val( 'external_write_ok'                               )
		self._handle_val( 'io_uring_ok'                                     )
