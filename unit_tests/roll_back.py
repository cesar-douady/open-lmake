...
if __name__!='__main__' :
	...
	print('step=1',file=open('step.py','w'))
	ut.lmake( 'cmd_light' , 'cmd_heavy' , 'rule_light' , 'rule_heavy' , 'dep_dut' , steady=2 , done=3 , new=1 ) # for now all rule/cmd modification imply a rebuild, even in case of roll back
