...
if __name__!='__main__' :
	...
	print('step=2',file=open('step.py','w')) ; ut.lmake( no_dump=True                                                      , rc=8 ) # job script is prepared in server, no local module access
	...
	print('step=3',file=open('step.py','w')) ; ut.lmake( no_dump=True                                                      , rc=8 ) # dynamic attribute is prepared in server, no local module access
	...
	print('step=4',file=open('step.py','w')) ; ut.lmake( no_dump=True                                                      , rc=8 ) # same for python
