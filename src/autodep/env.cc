...
namespace Codec {
	...
	CodecRemoteSide::CodecRemoteSide( NewType , ::string const& dir_s ) {
		...
		//
		::string init_msg  = cat("echo <val> >",dir_s,AdminDirS,"file_sync # with <val> being one of none, dir or readdir or a filesystem") ;
