...
namespace Backends {
	...
	void Backend::s_config( ::array<Config::Backend,N<Tag>> const& config , bool dynamic ) {
		...
		static JobThread      job_start_thread      {'S',_s_handle_job_start      ,JobExecBacklog} ; _s_job_start_thread       = &job_start_thread       ;
		static JobMngtThread  job_mngt_thread       {'M',_s_handle_job_mngt       ,JobExecBacklog} ; _s_job_mngt_thread        = &job_mngt_thread        ;
		static JobThread      job_end_thread        {'E',_s_handle_job_end        ,JobExecBacklog} ; _s_job_end_thread         = &job_end_thread         ;
